            ...
            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <li class="scrollable-container media-list">
                    <div class="media align-items-center"><img class="d-block rounded mr-1"
                            src="../../../theme/images/pages/eCommerce/1.png" alt="donuts" width="62">
                    ...
                    <div class="media align-items-center"><img class="d-block rounded mr-1"
                            src="../../../theme/images/pages/eCommerce/7.png" alt="donuts" width="62">
                        <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                            <div class="media-heading">
                                <h6 class="cart-item-title"><a class="text-body"
                    ...
                    <div class="media align-items-center"><img class="d-block rounded mr-1"
                            src="../../../theme/images/pages/eCommerce/2.png" alt="donuts" width="62">
                        <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                            <div class="media-heading">
                                <h6 class="cart-item-title"><a class="text-body"
                    ...
                    <div class="media align-items-center"><img class="d-block rounded mr-1"
                            src="../../../theme/images/pages/eCommerce/3.png" alt="donuts" width="62">
                        <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                            <div class="media-heading">
                                <h6 class="cart-item-title"><a class="text-body"
                    ...
                    <div class="media align-items-center"><img class="d-block rounded mr-1"
                            src="../../../theme/images/pages/eCommerce/5.png" alt="donuts" width="62">
                        <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                            <div class="media-heading">
                                <h6 class="cart-item-title"><a class="text-body"
                ...
                <li class="scrollable-container media-list">
                        ...
                        <div class="media d-flex align-items-start">
                            <div class="media-left">
                                <div class="avatar"><img
                                        src="../../../theme/images/portrait/small/avatar-s-15.jpg" alt="avatar"
                    ...
                    <a class="d-flex" href="javascript:void(0)">
                        <div class="media d-flex align-items-start">
                            <div class="media-left">
                                <div class="avatar"><img
                                        src="../../../theme/images/portrait/small/avatar-s-3.jpg" alt="avatar"
                                        width="32" height="32"></div>
                            </div>
                            <div class="media-body">
        ...
        <li class="nav-item dropdown dropdown-user">
            <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
                ...
                <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">John
                        ...
                        class="round" src="../../../theme//images/portrait/small/avatar-s-11.jpg" alt="avatar"
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user"><a
                ...
                <a class="dropdown-item" href="app-todo.html"><i class="mr-50" data-feather="check-square"></i>
